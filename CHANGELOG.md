...
## [0.1.0-rc.0](https://github.com/IBM/appconfiguration-rust-sdk/releases/tag/v0.1.0-rc.0) - 2026-06-18

### Added

- Support waiting for different client states ([#111](https://github.com/IBM/appconfiguration-rust-sdk/pull/111))
...
- Rust sdk beta release ([#129](https://github.com/IBM/appconfiguration-rust-sdk/pull/129))
...
- Use CLI for `release-plz` ([#47](https://github.com/IBM/appconfiguration-rust-sdk/pull/47))
- Use release-plz as the release tool ([#43](https://github.com/IBM/appconfiguration-rust-sdk/pull/43))
- Run all pre-commits ([#44](https://github.com/IBM/appconfiguration-rust-sdk/pull/44))
- Config for cargo-release ([#42](https://github.com/IBM/appconfiguration-rust-sdk/pull/42))
- Small changes, preparing for a release ([#40](https://github.com/IBM/appconfiguration-rust-sdk/pull/40))
- Curate dependencies ([#38](https://github.com/IBM/appconfiguration-rust-sdk/pull/38))
- [v0.1.0] Finish documentation ([#37](https://github.com/IBM/appconfiguration-rust-sdk/pull/37))
- `AppConfigurationClient` as a trait + IBMCloud implementation ([#34](https://github.com/IBM/appconfiguration-rust-sdk/pull/34))
- Provide a `get_value_into` function to return a primitive type from `Feature` and `Property` ([#35](https://github.com/IBM/appconfiguration-rust-sdk/pull/35))
- Use `cargo-readme` to generate the README from the Rust docs ([#36](https://github.com/IBM/appconfiguration-rust-sdk/pull/36))
- Remove `AttrValue`, we only have `Value` (with more explicit types) ([#33](https://github.com/IBM/appconfiguration-rust-sdk/pull/33))
- Minimize exposed API
- Declare a Property trait, implement PropertyProxy in terms of inner Property ([#28](https://github.com/IBM/appconfiguration-rust-sdk/pull/28))
- Merge branch 'main' into api/feature-trait
- do not store segment in error, only segment id
- Use detailed error - Remove anyhow ([#25](https://github.com/IBM/appconfiguration-rust-sdk/pull/25))
- Run all pre-commit hooks in all the files ([#24](https://github.com/IBM/appconfiguration-rust-sdk/pull/24))
- Merge remote-tracking branch 'origin/main' into 2024-12-06_error_handling
- Merge branch 'main' into 2024-12-05_more_error_handling
- Add pre-commit hooks ([#23](https://github.com/IBM/appconfiguration-rust-sdk/pull/23))
- Start using `thiserror` for errors in the library ([#19](https://github.com/IBM/appconfiguration-rust-sdk/pull/19))
- IBM Cloud App Configuration Rust SDK ([#13](https://github.com/IBM/appconfiguration-rust-sdk/pull/13))
- Create rust.yml
- Add initial README ([#12](https://github.com/IBM/appconfiguration-rust-sdk/pull/12))
- Update README.md
- Initial commit
