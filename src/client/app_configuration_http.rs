...
use crate::network::configuration_sync::{CurrentMode, LiveConfiguration, LiveConfigurationImpl};
...
mod tests {
    ...
    use crate::network::configuration_sync::CurrentMode;
    ...
    impl LiveConfiguration for LiveConfigurationMock {
        fn get_configuration(&self) -> crate::network::configuration_sync::Result<Configuration> {
        ...
        fn get_current_mode(&self) -> crate::network::configuration_sync::Result<CurrentMode> {
            todo!()
        }
    }
